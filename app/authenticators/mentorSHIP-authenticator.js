...
/**
  Authenticator intended to trigger a specific server side OAuth process

  @class mentorSHIP-authenticator
  @module ember-simple-auth/authenticators/mentorSHIP-authenticator
...
export default BaseAuthenticator.extend({
  ...
  */
  ...
  /**
    ...
    @public
  */
  serverTokenEndpoint: '/start_auth',
  ...
  */
  ...
  authenticate() {
    return new RSVP.Promise((resolve, reject) => {
      const serverTokenEndpoint = this.get('serverTokenEndpoint');
      this.makeRequest(serverTokenEndpoint).then((response) => {
        run(() => {
          resolve(response);
        });
      }, (xhr) => {
